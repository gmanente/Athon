...
{
    public partial class MapaCalourosVeteranosRel : CommonPage
    {
        protected new void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    report.Load(Server.MapPath("~/View/Report/GestaoAdministrativa/Stimull/MapaCalourosVeteranosRel.mrt"));
                    ...
                    string periodoLetivoSigla = Convert.ToString(Request.QueryString["periodoLetivoSigla"]);
                    ...
                    report["vPeriodoLetivoSigla"] = periodoLetivoSigla;
                    report["vCampusNome"] = campusNome;


                    report.ReportName = "Mapa de Alunos Calouros e Veteranos";

                    //stiMapaCalourosVeteranosRel.Report = report;
