...
{
    public partial class GestaoAdministrativaSalaLocalizacaoRel : CommonPage
    {
        protected new void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    report.Load(Server.MapPath("~/View/Report/GestaoAdministrativa/Stimull/GestaoAdministrativaSalaLocalizacaoRel.mrt"));
                    ...
                    stiGestaoAdministrativaSalaLocalizacaoRel.Report = report;
