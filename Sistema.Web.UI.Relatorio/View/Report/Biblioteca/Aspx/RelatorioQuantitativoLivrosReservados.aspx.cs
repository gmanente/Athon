...
{
    public partial class RelatorioQuantitativoLivrosReservados : CommonPage
    {
        protected new void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    if (Audit.Autenticar("RF015"))
                    {
                        report.Load(Server.MapPath(@"~\View\Report\Biblioteca\Stimull\RelatorioQuantitativoLivrosReservados" + (ModeloRelatorio.Equals("2") ? "-Bruto.mrt" : ".mrt")));
