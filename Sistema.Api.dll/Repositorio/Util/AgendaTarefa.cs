...
namespace Sistema.Api.dll.Repositorio.Util
{
    ...
    {
        private static Dictionary<string, AgendaTarefa> SchedulePool = new Dictionary<string, AgendaTarefa>();
        ...
        public  AgendaTarefa(TimerCallback Method)
        {
        ...
        public void AddTarefa(object State, StartTime horario)
        {
            start = horario;
            if (ID != null)
            {
        ...
        public class Control
        {
            ...
            /// <returns></returns>
            public static AgendaTarefa GetTimer(String ScheduleId)
            {
            ...
            {
                AgendaTarefa schedule = GetTimer(ScheduleId);
                schedule.Dispose();
            }
