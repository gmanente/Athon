...
{
    public partial class RelatorioGeralPeriodicoOnline : CommonPage
    {
        protected new void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    if (Audit.Autenticar("RF021"))
                    {
                        report.Load(Server.MapPath(@"~\View\Report\Biblioteca\Stimull\RelatorioGeralPeriodicoOnline" + (ModeloRelatorio.Equals("2") ? "-Bruto.mrt" : ".mrt")));
