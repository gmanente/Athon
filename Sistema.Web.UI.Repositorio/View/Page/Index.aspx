<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Sistema.Web.UI.Repositorio.View.Page.Index" %>
...
<<body>
    ...
    <div class="container" style="padding-top:100px;"> 
        <form id="form" runat="server">
           ...
           <div class="panel">
                <h1 class="error-text">
                    <i class="fa fa-cloud-download"></i> Repositório
                </h1>

                <div class="row">
                   <div class="col-md-12">
                        <h2 class="error-msg">Este domínio é parte integrante do Sistema</h2>
                   </div>
                </div>               
                <div class="row">
                   <div class="col-md-12">
