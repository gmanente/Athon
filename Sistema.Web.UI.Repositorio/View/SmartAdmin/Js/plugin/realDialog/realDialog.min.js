...
; (function ($) {
    ...
    */
    $('body').on('mousedown', 'h3.real-dialog-title-dialog', function (e) {
        ...
        $(divt).css('position', 'absolute').css('left', '0').css('top', '0'); //.css('background', 'red');
    ...
    $(document).on('keydown', function (e) {
        if (e.which == 27) {
            ...
            if (element != undefined) {
                ...
                alert('Nehuma janela em foco para fechar.')
            }
        };
    })
    ...
    */
    $('body').on('mouseover', '#real-dialog-footer nav', function () {
        ...
        $('#real-dialog-info').attr('title', 'Abertas: ' + qDialogsOpen + ' / Minimizadas: ' + qDialogsMinimize + ' / Escondidas: ' + qDialogsHidden);
