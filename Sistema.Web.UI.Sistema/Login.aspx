<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Sistema.Web.UI.Sistema.Login" %>
    ...
    <div id="particles">
        ...
        <noscript>
            <h2>
                ...
                e aprenda como habilita-lo para utilizar o Sistema.
            </h2>
        </noscript>
        <!-- FIM NOSCRIPT -->
        ...
        <div class="container">
            ...
            <form id="form" runat="server">
                ...
                <input type="hidden" id="BrowserTipo" value="<%=Request.Browser.Win32 ? "Win32" : "Win64" %>" />
                ...
                <!-- FIM CAMPOS OCULTOS -->
                <%--<input type="hidden" id="iplocal" value="<%=Dominio.GetIpLocalAppState() %>" />--%>
                ...
                <div id="content-login" class="form-signin">
                    ...
                    <!-- INÍCIO LOGO -->
                    <a href="/Login.aspx" id="login_logo" class="ajax" data-window="Login" title="Athon Sistemas">
                    ...
                    <div id="box-Login" class="form-content">
                        ...
                        <h4>
                            <%=ambiente != "" ? "<p style=\"color: #7517d3\">" + ambiente + "</p>" : "" %>
                        ...
                        <div id="console">
                            ...
                            <div class='alert alert-dismissable alert-warning'>
                                ...
                                <strong>Situação:</strong> Sessão expirada!<br />
                            ...
                            <div class='alert alert-dismissable alert-info'>
                                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                                <strong>Situação:</strong> Usuário deslogado.<br />
                            ...
                            <div class='alert alert-dismissable alert-warning'>
                                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                                <strong>Situação:</strong> Usuário deslogado por outro acesso.<br />
                                Para realizar login novamente preencha os campos abaixo.
                            </div>
                            <%  }
                                // Senha alterada
                                else if (senhaAlterada != null && senhaAlterada == "true")
                                { %>
                            <div class='alert alert-dismissable alert-info'>
                                <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
                                <strong>Situação:</strong> Usuário deslogado.<br />
                        ...
                        <!-- INÍCIO BOTÃO ENTRAR -->
                        <button type="button" class="btn btn-lg btn-primary btn-block" id="btn-entrar" <%--style="background-image: -webkit-linear-gradient(top, #510c66 0%, #510c66 100%);"--%> disabled="disabled">
                        ...
                        <a href="/Login.aspx/RecuperarSenha" class="btn btn-lg btn-default btn-block ajax" id="btn-recuperar" data-window="RecuperarSenha">
                    ...
                    <div id="box-RecuperarSenha" class="form-content">
                        <h4>
                            <%=ambiente != "" ? "<p style=\"color: #ab70ea\">" + ambiente + "</p>" : "" %>
                        ...
                        <a href="/Login.aspx" class="btn btn-lg btn-default btn-block ajax" data-window="Login">
        ...
        <%= Funcoes.InvocarTagArquivo("js/login.js", true) %>
        <%= Funcoes.InvocarTagArquivo("js/jquery.particleground.js", true) %>
