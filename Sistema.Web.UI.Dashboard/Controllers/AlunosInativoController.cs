...
{
    public class AlunosInativoController : AbstractController
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public IHttpActionResult GetDadosCurso(long idCampus, long idGpa, long idPeriodoLetivo, bool situacaoAcademicaAtivo = true)
        {
        ...
        /// <returns></returns>
        [HttpGet]
        public IHttpActionResult GetDadosCursoTurma(int idCurso, int idPeriodoLetivo, bool situacaoAcademicaAtivo = true)
        {

            try
            {
                academicoBE = new AcademicoBE();
                var lst = academicoBE.ChartConsultaQuantitativoAlunoCursoTurma(idCurso, idPeriodoLetivo, situacaoAcademicaAtivo);
        ...
        /// <returns></returns>
        [HttpGet]
        public IHttpActionResult GetDadosAlunoCursoTurma(int idCampus, int idPeriodoletivo, int idGradeLetivaTurma, bool situacaoAcademicaAtivo = true)
        {
            try
            {
                academicoBE = new AcademicoBE();
                var lst = academicoBE.ListarAlunoSemestreTurma(idCampus, idPeriodoletivo, idGradeLetivaTurma, situacaoAcademicaAtivo);
                return Ok(lst);
            }
            catch (Exception ex)
            {
