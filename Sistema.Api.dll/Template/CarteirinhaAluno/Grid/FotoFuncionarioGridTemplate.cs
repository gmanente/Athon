...
{
    public class FotoFuncionarioGridTemplate : SubmoduloWireFrameTemplate
    {
        ...
        public FotoFuncionarioGridTemplate(string urlSubModulo, long idUsuario, long idCampus, bool acessoExterno)
            : base()
        {
        ...
        public void SetFotoTemplate()
        {
            ...
            if (Autenticar("RF006"))
            {
                ...
                if (BotaoInserir != null)
                {
                    ...
                    BotaoImprimirContainer.AddComponentContent(BotaoImprimir);
                }
            }
            ...
            if (Autenticar("RF005"))
            {
                ...
                {
                    Arr = "{ pagina:'../Page/FotoFuncionario.aspx'}",
                    ...
                    Button = "false",
                    ValidationRules = "{}",
                    RequestUrl = "'../Page/FotoFuncionario.aspx'",
        ...
        public string GetAjaxCall()
        {
            ...
            {
                ContentCode = "var idFotoFuncionario  = $(this).parent('li').attr('data-id');",
                Arr = "{idFotoFuncionario:idFotoFuncionario}",
        ...
        public string MontarModalExcluir(long idFotoFuncionario)
        {
            ...
            {
                Id = "IdFotoAluno",
                Value = idFotoFuncionario.ToString(),
                Name = "IdGradeConsepe"
            };
