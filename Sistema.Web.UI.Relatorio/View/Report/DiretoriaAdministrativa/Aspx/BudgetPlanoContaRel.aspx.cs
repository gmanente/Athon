...
{
    public partial class BudgetPlanoContaRel : CommonPage
    {
        protected new void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Audit.Autenticar("RF003"))
                {
                    ...
                    report.Load(Server.MapPath("~/View/Report/DiretoriaAdministrativa/Stimull/BudgetPlanoContaRel.mrt"));
                    ...
                    report.ReportName = "BudgetPorPlanoContaRel(" + DateTime.Now.ToString("dd-MM-yyyy-HH-mm") + ")";

                    stiBudgetPlanoContaRel.Localization = "pt-BR";
                    stiBudgetPlanoContaRel.FullScreenMode = true;
                    stiBudgetPlanoContaRel.Report = report;
                }
            }
            catch (Exception ex)
            {
