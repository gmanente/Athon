...
{
    public partial class RelatorioExemplaresCurso : CommonPage
    {
        protected new void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        report.Load(Server.MapPath(@"~\View\Report\Biblioteca\Stimull\RelatorioExemplaresCurso" + (ModeloRelatorio.Equals("2") ? "-Bruto.mrt" : ".mrt")));
                        ...
                        string TipoCurso = Server.UrlDecode(Request.GetStr("TipoCursoTxt"));
                        ...
                        long IdCurso = Request.GetInt("TipoCurso");
                        ...
                        if (IdCurso > 0)
                            query += string.Format(" AND Curso.IdCurso = {0} ", IdCurso);
