...
{
    public partial class AlunoCarteirinhaTotalCursoRel : CommonPage
    {
        protected new void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    report.Load(Server.MapPath("~/View/Report/CarteirinhaAluno/Stimull/AlunoCarteirinhaTotalCursoRel.mrt"));
                    ...
                    report.CompiledReport.DataSources["dataset_visaogeral"].Parameters["pDataFinal"].ParameterValue = dataFinal;
