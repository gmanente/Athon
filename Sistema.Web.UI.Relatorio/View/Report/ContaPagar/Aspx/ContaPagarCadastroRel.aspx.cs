...
{
    public partial class ContaPagarCadastroRel : CommonPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    report.Load(Server.MapPath("~/View/Report/ContaPagar/Stimull/ContaPagarCadastroRel.mrt"));
                    ...
                    //StiContaPagarCadastroRel.Report = report;
