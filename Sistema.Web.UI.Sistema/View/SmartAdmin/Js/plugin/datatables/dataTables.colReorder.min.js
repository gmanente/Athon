    ...
    var g = function (a) {
        ...
        return f.prototype = {
            ...
            _fnOrderColumns: function (b) {
                if (b.length != this.s.dt.aoColumns.length) return void this.s.dt.oInstance.oApi._fnLog(this.s.dt, 1, "ColReorder - matriz de reabastecimento não corresponder ao número conhecido de colunas. Ignorando.");
            ...
            fnInit: function (a) {
                var b = a.oInstance;
                if (a._colReorder) b.oApi._fnLog(a, 1, "ColReorder tentou inicializar duas vezes. ignorando segunda");
                else {
                    var c = a.oInit,
