...
{
    public partial class RelatorioItensMaisEmprestados : CommonPage
    {
        protected new void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        report.Load(Server.MapPath(@"~\View\Report\Biblioteca\Stimull\RelatorioItensMaisEmprestados" + (ModeloRelatorio.Equals("2") ? "-Bruto.mrt" : ".mrt")));
