...
namespace Sistema.Api.dll.Template.Productive.Master
{
    public class ProductiveMasterTemplate : SubmoduloMasterTemplate
    {
        private List<ItemMenu> ListItemMenu { get; set; }

        public ProductiveMasterTemplate(long idCampus, string urlModulo, long idUsuario, bool acessoExterno) : base()
        {
