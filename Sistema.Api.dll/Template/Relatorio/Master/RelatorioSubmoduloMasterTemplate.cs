...
namespace Sistema.Api.dll.Template.Relatorio.Master
{
    public class RelatorioSubmoduloMasterTemplate : SubmoduloMasterTemplate
    {
        private List<ItemMenu> ListItemMenu { get; set; }

        public RelatorioSubmoduloMasterTemplate(long idCampus, string urlModulo, long idUsuario, bool acessoExterno)
            : base()
        {
