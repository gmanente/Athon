...
{
    public partial class RelatorioPeriodoMultasChave : CommonPage
    {
        protected new void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    if (Audit.Autenticar("RF018"))
                    {
                        report.Load(Server.MapPath(@"~\View\Report\Biblioteca\Stimull\RelatorioPeriodoMultasChave" + (ModeloRelatorio.Equals("2") ? "-Bruto.mrt" : ".mrt")));
