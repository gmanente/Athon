...
namespace Cielo
{
    ...
    public class Payment : ReturnStatus
    {
        ...
        public Payment(decimal amount, string returnUrl, DebitCard debitCard)
        {
        ...
        public string SoftDescriptor
        {
            ...
            set
            {
                if (value != null && (value.Length > 13 || !softDescriptorMatch.IsMatch(value)))
                {
                    throw new ArgumentException("SoftDescriptor: limitado a 13 caracteres (não especiais) e sem espaços.");
                }
