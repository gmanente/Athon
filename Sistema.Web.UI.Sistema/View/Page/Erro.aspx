<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Erro.aspx.cs" Inherits="Sistema.Web.UI.Seguranca.View.Page.Erro" %>
...
<body>
    ...
    <!-- INÍCIO RODAPÉ -->
    <footer id="footer">
        <p>© <%= DateTime.Now.Year %> Athon Sistemas.</p>
    </footer>
    <!-- FIM RODAPÉ -->
</body>
</html>