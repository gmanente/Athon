    ...
    return a.addDeviceType = function () {
        ...
        var a = {
            userLogout: function (a) {
                ...
                $.SmartMessageBox({
                    title: "<i class='fa fa-sign-out txt-color-orangeDark'></i> Sair / Logou de <span class='txt-color-orangeDark'><strong>" + $("#show-shortcut").text() + "</strong></span>",
                    content: a.data("logout-msg") || "Por medida de maior segurança, feche este navagador aberto após o logout.",
                    buttons: "[Confirmar][Cancelar]"
                }, function (a) {
                    "Confirmar" == a && ($.root_.addClass("animated fadeOutUp"), setTimeout(b, 1e3));
                });
            },
            resetWidgets: function (a) {
                $.widresetMSG = a.data("reset-msg"), $.SmartMessageBox({
                    title: "<i class='fa fa-refresh' style='color:green'></i> Limpar Local Storage",
                    content: $.widresetMSG || "Would you like to RESET all your saved widgets and clear LocalStorage?",
                    buttons: "[Cancelar][Confirmar]"
                }, function (a) {
                    "Confirmar" == a && localStorage && (localStorage.clear(), location.reload());
                });
            },
            ...
            toggleMenu: function () {
                ...
                $('#real-dialog-minimize-all-dialogs').trigger('click');
            },
