    ...
    public partial class UsuarioCampus : CommonPage
    {
        ...
        public static string MontarModalInserir()
        {
            ...
            try
            {
                ...
                var inserirTemplate = new UsuarioCampusFormularioTemplate() {Id = "modal-inserir", Titulo = "Cadastrar ", Descricao = "Preencha as informações abaixo para realizar a inserção."};
        ...
        public static string MontarModalAlterar(long idUsuarioCampus)
        {
            ...
            try
            {
                ...
                var inserirTemplate = new UsuarioCampusFormularioTemplate()
                {
                    Id = "modal-alterar",
                    Titulo = "Alterar ",
                    Descricao = "Preencha as informações abaixo para realizar a alteração."
                };
        ...
        public static string InserirUsuarioCampusAjax(Object inputs)
        {
            ...
            try
            {
                ...
                ajax.AddMessage("Registro inserido com sucesso.", Mensagem.Sucesso);
            }
            catch (Exception ex)
            {
        ...
        public static string AlterarUsuarioCampusAjax(Object inputs)
        {
            ...
            try
            {
                ...
                ajax.StatusOperacao = true;
                ajax.Variante = GetGridTemplate().GetGrid();
                ajax.AddMessage("Registro Aterado com sucesso.", Mensagem.Sucesso);
        ...
        public static string ExcluirUsuarioCampusAjax(long idUsuarioCampus)
        {
            ...
            try
            {
                ...
                ajax.AddMessage("Cadastro deletado com sucesso.", Mensagem.Sucesso);
            }
            catch (Exception e)
            {
                ajax.StatusOperacao = false;

                ajax.SetMessage("Não foi possivel excluir a Campus, verifique se não registros dependentes.", Mensagem.Erro);
            }
            finally
            {
                if (usuarioCampusBe != null)
