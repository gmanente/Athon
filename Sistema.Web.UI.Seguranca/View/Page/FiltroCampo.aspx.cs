    ...
    public partial class FiltroCampo : CommonPage
    {
        ...
        public static string GerarScript()
        {
            ...
            try
            {
                ...
                SbQuery.AppendLine("DELETE FROM DBComum.dbo.FiltroCampo WHERE DBComum.dbo.FiltroCampo.IdFiltro = " + FiltroSession.Id);
                SbQuery.AppendLine();
                ...
                if (FiltroSession.LstFiltroCampos.Count > 0)
                {
                    ...
                    {
                        SbQuery.AppendLine("INSERT INTO DBComum.dbo.FiltroCampo VALUES "
                       + "((SELECT MAX(IdFiltroCampo) + 1 FROM DBComum.dbo.FiltroCampo), "
                       + FiltroSession.Id + ", "
