...
{
    public partial class ContaPagarQuitadoModalidadeRel : CommonPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    report.Load(Server.MapPath("~/View/Report/ContaPagar/Stimull/ContaPagarQuitadoModalidadeRel.mrt"));
                    ...
                    string idModalidadeFinanceira = Request.QueryString["idModalidadeFinanceira"];
                    ...
                    report["vIdModalidadeFinanceira"] = idModalidadeFinanceira;
