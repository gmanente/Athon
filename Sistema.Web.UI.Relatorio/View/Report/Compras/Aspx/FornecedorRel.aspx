<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FornecedorRel.aspx.cs" Inherits="Sistema.Web.UI.Relatorio.View.Report.Compras.Aspx.FornecedorRel" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <cc1:StiWebViewer ID="stiFornecedorRel" runat="server" />
        </div>
    </form>
</body>
</html>
