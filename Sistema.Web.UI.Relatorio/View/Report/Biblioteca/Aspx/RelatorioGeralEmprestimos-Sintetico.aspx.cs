...
{
    public partial class RelatorioGeralEmprestimos_Sintetico : CommonPage
    {
        protected new void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        report.Load(Server.MapPath(@"~\View\Report\Biblioteca\Stimull\RelatorioGeralEmprestimos-Sintetico" + (ModeloRelatorio.Equals("2") ? "-Bruto.mrt" : ".mrt")));
