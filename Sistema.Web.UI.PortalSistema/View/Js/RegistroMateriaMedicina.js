...
$(document).ready(function ()
{
    ...
    $("#lblNomeModulo").html('<li><i class="fa fa-home"></i><a href="/View/Page/RegistroMateriaMedicina.aspx"> Registro de Matéria</a></li>')
    ...
    $('#Campus').on('change', function (e) {
        ...
        chamadaAjax("/View/Page/RegistroMateriaMedicina.aspx", "UsuarioFuncionalidade", { idCampus: getIdCampus },
            function (objJson) {
...
function carregarPeriodoLetivo()
{
    ...
    idCampus = $('#Campus').val();
        ...
        jqxhr = $.ajax({
            type: 'POST',
            url: '../Page/RegistroMateriaMedicina.aspx/ListarPeriodoLetivo',
...
function fnSalvarRegistromateria()
{
    ...
    jqxhr = $.ajax({
        type: 'POST',
        url: '../Page/RegistroMateriaMedicina.aspx/' + method,
        data: data,
        contentType: 'application/json; charset=utf-8',
        dataType: 'json'
    })
...
function ConsultarHorarios()
{
    ...
    if (idCampus > 0 && idPeriodoLetivo > 0) {
        ...
        var jqxhr = $.ajax({
            type: 'POST',
            url: '../Page/RegistroMateriaMedicina.aspx/ListarDisciplinas',
            data: '{ idCampus: "' + idCampus +
                    ...
                    else
                    {
                        $.each(lstDisciplinaOferta, function (key2, value2)
                        {
                            ...
                            if ($("#authRf003").val() == "True") {
                                rf003 = "<li>"
                                          + "<a href='../Report/RegistroMateria/Aspx/RegistroMateriaMedicinaRel.aspx?idDisciplinaOfertaProfessor=" + value2[0].DisciplinaOfertaHorarioProfessor.DisciplinaOfertaProfessor.Id + "&idGradeLetivaDisciplina=" + idGradeLetivaDisciplina + "&idDisciplinaOferta=" + value2[0].DisciplinaOferta.Id + "&idDisciplinaIntegrada=" + idDisciplinaIntegrada +  "'"
                        ...
                        $('.item-acao-registro').on("click", function (event)
                        {
                            ...
                            $("#ModalTitulo").text("Registro de Matéria do Módulo - " + $(this).attr("data-disciplina"));
...
function CarregarRegistrosInseridos(idGradeLetivaDisciplina, idDisciplinaOferta)
{
    ...
    var jqxhr = $.ajax({
        type: 'POST',
        url: '../Page/RegistroMateriaMedicina.aspx/ListarRegistrosLancados',
        data: '{ idGradeLetivaDisciplina: "' + idGradeLetivaDisciplina +
...
function CarregarPlanoEnsinoCronograma() {
    ...
    {     
        var jqxhr = $.ajax({
            type: 'POST',
            url: '../Page/RegistroMateriaMedicina.aspx/TrazerSemanaCronogramaPlanoEnsino',
            data: JSON.stringify({
                idDisciplinaOferta: idDisciplinaOferta,
                semana: semana
            }),
...
function fnCarregarDiasRestantes(idDisciplinaOfertaProfessor, idDisciplinaOferta, idGradeLetivaDisciplina, idRegistroMateria, numeroAula, idCampus, idPeriodoLetivo)
{
    ...
    var jqxhr = $.ajax({
        type: 'POST',
        url: '../Page/RegistroMateriaMedicina.aspx/TrazerDiasRestantes',
        data: JSON.stringify({
            idDisciplinaOfertaProfessor: idDisciplinaOfertaProfessor,
            idDisciplinaOferta: idDisciplinaOferta,
            idGradeLetivaDisciplina: idGradeLetivaDisciplina,
    ...
    .done(function (data, textStatus, jqXHR)
    {
        ...
        else
        {
            ...
            {    
                ...
                $("#slfDiaAula").html("");
                var html = "<option value='0'>Selecione a Semana</option>";
                // Remove as mensagens iniciais da grid             
                var lstAula = {};
                $.each(listObj, function (key, value)
                {                    
