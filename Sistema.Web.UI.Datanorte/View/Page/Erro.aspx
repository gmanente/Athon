<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Erro.aspx.cs" Inherits="Sistema.Web.UI.Datanorte.View.Page.Erro" %>
...
<head id="Head1" runat="server">
    ...
    <title><%=Title %>Athon Sistemas</title>
...
<body>
                   ...
                   <div class="col-md-12">
                       <ul class="error-links">
                           <%
                            ...
                            <% if ((Request.QueryString["s"] != null && Request.QueryString["s"].ToString() == "sessao-expirada") || Status == "401") { %>
                           <li><a target="_parent" href="<%=url %>/Login.aspx">Fazer novo Login</a></li>
                           <% } else { %>
                           <li><a href="<%= SubModuloUrl %>">Voltar Página</a></li>
                           <% } %>
                       </ul>                        
                   </div>
               </div>
    ...
    <!-- INÍCIO LOGO RODAPÉ -->
    <img id="logo-login" alt="Athon" title="Athon Sistemas" />
    <!-- FIM LOGO RODAPÉ -->
