...
{
    public partial class GestaoAdministrativaEvasaoQuadroGeralRel : CommonPage
    {
        protected new void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    report.Load(Server.MapPath("~/View/Report/GestaoAdministrativa/Stimull/GestaoAdministrativaEvasaoQuadroGeralRel.mrt"));
                    ...
                    stiGestaoAdministrativaEvasaoQuadroGeral.Report = report;
