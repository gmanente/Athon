...
namespace Sistema.Api.dll.Template.CarteirinhaAluno.Master
{
    public class CarteirinhaAlunoSubmoduloMasterTemplate : SubmoduloMasterTemplate
    {
        private List<ItemMenu> ListItemMenu { get; set; }

        public CarteirinhaAlunoSubmoduloMasterTemplate(long idCampus, string urlModulo, long idUsuario, bool acessoExterno)
            : base()
        {
